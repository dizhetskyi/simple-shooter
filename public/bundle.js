...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  function Game() {
	    ...
	    _constants.canvas.width = _constants.game_width;
	    _constants.canvas.height = _constants.game_height;
	  }

	  _createClass(Game, [{
	    key: 'init',
	    value: function init() {
	      _constants.ctx.fillStyle = '#000';
	      _constants.ctx.fillRect(0, 0, _constants.game_width, _constants.game_height);
	...
	var Ball = function () {
	  function Ball() {
	    ...
	    this.size = 25;
	    this.x = _constants.game_width / 2 - this.size / 2;
	    this.y = _constants.game_height / 2 - this.size / 2;
	    this.vx = .2;
	    this.vy = .2;
	  ...
	  _createClass(Ball, [{
	    ...
	    value: function update(dt) {
	      ...
	      if (this.x + dx + this.size > _constants.game_width || this.x + dx < 0) {
	        this.xDir *= -1;
	      }

	      if (this.y + dy + this.size > _constants.game_height || this.y + dy < 0) {
	        this.yDir *= -1;
	      }
	    ...
	    value: function draw() {
	      ...
	      _constants.ctx.fillStyle = '#fff';
	      _constants.ctx.fillRect(this.x, this.y, this.size, this.size);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.game_height = exports.game_width = exports.ctx = exports.canvas = exports.socket = undefined;
	...
	var socket = exports.socket = _socket2.default.connect('http://localhost:1337');

	var canvas = exports.canvas = document.getElementById('game');
	var ctx = exports.ctx = canvas.getContext('2d');

	var game_width = exports.game_width = 600;
	var game_height = exports.game_height = 480;
